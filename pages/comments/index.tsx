...
const Comments: NextPage = () => {
  return (
    <div>
      <Meta title={'Comments - Highlight'} description={'Comments by Highlight'} />
      ...
      <main>
        <Section>
          <div className={styles.anchorTitle}>
            <div className={classNames(styles.sectionText, commentStyles.commentDiv)}>
              <h1>Introducing: Comments by Highlight</h1>
              <p className={styles.bodyLarge}>
                Now, in addition to session replay and monitoring, you can have free flowing conversations related to
