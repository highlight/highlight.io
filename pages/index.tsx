					...
					<div className={styles.anchorFeature}>
						<div className={styles.anchorHead}>
							...
							<Typography type="copy1" onDark>
								Stop wasting effort trying to track down and
								reproduce bugs. Through session replay,
								Highlight shows you exactly how and when your
								bugs happen. Highlight removes the mystery of
								debugging.
							</Typography>
						</div>
						<div
						...
						<div className={styles.featureContainer}>
							<FeatureItem>
								...
								<Typography type="copy2" onDark>
									See exactly how users are impacted by
									errors.
								</Typography>
							</FeatureItem>
							<FeatureItem>
								...
								<Typography type="copy2" onDark>
									Access full, language-specific stack traces
									on your web app.
								</Typography>
							</FeatureItem>
							<FeatureItem>
								...
								<Typography type="copy2" onDark>
									Debug with everything you get in the
									dev-tools console.
								</Typography>
							</FeatureItem>
							<FeatureItem>
								...
								<Typography type="copy2" onDark>
									Understand when bugs happen and everything
									that leads to it.
								</Typography>
							</FeatureItem>
						</div>
				...
				<div className={styles.secondaryBackground}>
								...
								>
									<div>
										...
										<h3>
											...
											on bugs, everyone is kept in the
											loop.
										</h3>
										<Collapse
											accordion
										...
										>
											...
											>
												...
												>
													<Typography type="copy2">
														When something breaks on
														your web app, there are
														many teams that could
														get the first message
														about it. Highlight
														makes it easy to
														communicate and
														re-assign issues to make
														decisions on errors
														faster.
													</Typography>
												</div>
								...
								>
									<div>
										...
										<h3>
											...
											for a bug by session or specific
											property.
										</h3>
										<Collapse
											accordion
										...
										>
											...
											>
												...
												>
													<Typography type="copy2">
														What if you step in the
														shoes of your users and
														debug from their
														perspective? With our
														search console, you can
														instantly find the right
														session and debug with
														confidence.
													</Typography>
												</div>
											</Panel>
                    ...
                    What is slowing down your users?`}</Typography>
											...
											>
												...
												>
													<Typography type="copy2">
														Are users not using a
														new feature? Or is there
														a known drop off in a
														specific user flow? Our
														search console gives you
														the ability to search
														based on URL, number of
														errors, user properties
														and much more!
													</Typography>
												</div>
											</Panel>
							...
							>
								...
								>
									...
									>
										...
										<div
											className={
												styles.searchTwoHighlighters
											}
										>
											<Image
												src={TwoHighlightersImage}
												alt=""
											/>
										</div>
									</div>
							...
							>
								...
								>
									<div className={styles.sectionBody}>
										<Typography type="copy2">
											When something breaks on your web
											app, there are many teams that could
											get the first message about it.
											Highlight makes it easy to
											communicate and re-assign issues to
											make decisions on errors faster.
										</Typography>
									</div>
								</Panel>
								<Panel
						...
						<div className={styles.sectionText}>
							...
							>
								...
								>
									<div className={styles.sectionBody}>
										<Typography type="copy2">
											What if you step in the shoes of
											your users and debug from their
											perspective? With our search
											console, you can instantly find the
											right session and debug with
											confidence.
										</Typography>
									</div>
								</Panel>
                    ...
                    What is slowing down your users?`}</Typography>
								...
								>
									<div className={styles.sectionBody}>
										<Typography type="copy2">
											Are users not using a new feature?
											Or is there a known drop off in a
											specific user flow? Our search
											console gives you the ability to
											search based on URL, number of
											errors, user properties and much
											more!
										</Typography>
									</div>
								</Panel>
						...
						<div className={styles.sectionText}>
							...
							>
								...
								>
									<div className={styles.sectionBody}>
										<Typography type="copy2">
											Highlight supports data redaction,
											obfuscation, masking and much more.
											The library also supports a Strict
											Privacy Mode which obfuscates all
											text nodes for very strict PII
											rules.
										</Typography>
									</div>
								</Panel>
								...
								>
									<div className={styles.sectionBody}>
										<Typography type="copy2">
											Highlight supports several wellknown
