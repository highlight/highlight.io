			...
			>
				<div className={styles.desktopTierSection}>
					<div className={styles.desktopTopTier}>
						...
						{contactSales ? (
							<div
								className={
									styles.desktopSessionCreditsEnterprise
								}
							>
				...
				{features &&
					Object.keys(features).map((headingKey) => {
						return (
							<div
								className={styles.desktopFeaturesSection}
								key={headingKey}
							>
				...
				{isMobile ? (
					<Section className={styles.mobileTierWrapper}>
						<div className={styles.mobileBillingWrapper}>
							<Typography
								type="copy3"
								className={styles.billingCycleText}
							>
			...
			<div className={styles.mobileFeaturesWrapper}>
				<Typography type="copy3" emphasis>
					{Object.keys(planDetails[planIndex]).map((headingKey) => {
						let currentFeatureSection = (
							planDetails[planIndex] as any
						)[headingKey]
						return (
							<div
								className={styles.mobileFeaturesSection}
								key={headingKey}
							>
									...
									(featureKey: any, i: number) => {
										...
										return (
											<div
												key={i}
												className={
													styles.mobileFeatureRow
												}
											>
												<div
													className={
														styles.mobileFeatureInner
													}
												>
													<Typography
														type="copy3"
														className={
															styles.mobileFeatureName
														}
													>
														{currentFeature.name}
													</Typography>
...
const MobileTierSection = ({
	...
	return (
		<div
			...
			className={classNames(
				styles.mobileTierSectionWrapper,
				'embla__slide',
				{
		...
		>
			...
			>
				<div className={styles.mobileTierTop}>
					...
					<Typography
						type="copy3"
						className={styles.mobileSessionCredits}
					>
						{numSessionCredits
							? numSessionCredits.toLocaleString()
							: 'Custom'}{' '}
