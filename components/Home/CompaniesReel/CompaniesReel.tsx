    ...
    <div className={styles.anchorFeature} id="customers">
      ...
      <div className={styles.customerReel}>
        <div className={styles.companies}>
          ...
          <Image src={Hightouch} alt="Hightouch" className={styles.scaleHeight} style={{ transform: 'scale(1.1)' }} />
          ...
          <Image src={Airplane} alt="Airplane" className={styles.scaleHeight} />
          <div className={classNames(styles.tabletGraphic, styles.hideMobile)}></div>
          <Image src={Secoda} alt="Secoda" className={styles.scaleHeight} style={{ transform: 'scale(0.8)' }} />
        </div>
      </div>
    </div>
  )
