...
const supabase = createClient('https://zegkgkeylxjinmkhvszq.supabase.co', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyb2xlIjoiYW5vbiIsImlhdCI6MTYzNDYwOTE1MiwiZXhwIjoxOTUwMTg1MTUyfQ.Hk_ghyYR5dVn5ILfdB5iFX5vxQnwIBwegWJcp7TJloE', {
    realtime: {
        params: {
            eventsPerSecond: 10,
        },
...
export const Comments = function ({ slug }: { slug: string }) {
    ...
    const shouldAddComment = useCallback((comment: Comment): boolean => {
