...
const DOCS_REDIRECTS = {
  ...
  metrics: '/docs/getting-started/backend-sdk/nextjs/metrics',
  ...
  'api/networkrecordingoptions': '/docs/api/h-init/network-recording-options',
  'api/hidentify': '/docs/api/h-identify',
  'api/htrack': '/docs/api/h-track',
  'api/ljQK-hconsumeerror': '/docs/api/h-consume-error',
  'api/hmetrics': '/docs/api/h-metrics',
  'api/metrics': '/docs/api/h-metrics/metrics',
  'api/hgetsessiondetails': '/docs/api/h-get-session-details',
  'api/hgetsessionurl': '/docs/api/h-get-session-url',
  'api/hstart': '/docs/api/h-start',
  'api/hstop': '/docs/api/h-stop',
  'api/haddsessionfeedback': '/docs/api/h-add-session-feedback',
  'api/htogglesessionfeedbackmodal':
    '/docs/api/h-toggle-session-feedback-modal',
