...
Frontend Observability augments two key features: [Web Vitals](docId:1Xs5nXtQLiyGDNP7E-5Hs)  and [Performance Data](docId\:oqd-eiPHxh-GbJPFLCBCj).
...
To record metrics about your Frontend Network Requests, you'll need to configure your backend domains of interest. You can do this by [visiting your Project Setting page](https://app.highlight.run/settings) or by adding an extra configuration setting to your [H.init()](docId\:yo4FQx3odAtsQsbZOuG_m) call, like so:
