...
To tag your errors with a version, you can set the `version` field in the [`H.init()`](../../sdk-docs/client.md#Hinit).
...
`version` is used for sessions too, see [Versioning Sessions](../4_session-replay/versioning-sessions.md) for more information.
